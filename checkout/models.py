...
class Order(models.Model):
    ...
    user_profile = models.ForeignKey(User_profile, on_delete=models.SET_NULL, null=True, 
    ...
    originalBag = models.TextField(null=False, blank=False, default='')
...
class OrderItem(models.Model):
    order = models.ForeignKey(Order, null=True, blank=False, on_delete=models.CASCADE, related_name='items')
